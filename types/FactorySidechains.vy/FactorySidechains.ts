...
export interface FactorySidechainsInterface extends utils.Interface {
  functions: {
...
export interface FactorySidechains extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FactorySidechainsInterface;
